...
public class AdapterHomeActivitySlider extends FragmentStateAdapter {


    public AdapterHomeActivitySlider(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
