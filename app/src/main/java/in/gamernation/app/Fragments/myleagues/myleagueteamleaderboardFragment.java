...
public class myleagueteamleaderboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_myleagueteamleaderboard, container, false);
        initscreen();
        initviews(root);
        return root;
    }
    ...
    private void initviews(View root) {
        myleagueshowteamhead = root.findViewById(R.id.myleagueteamleaderboardshowteamhead);
        myleagueshowteambackbot = root.findViewById(R.id.myleagueteamleaderboardshowteambackbot);
        myleagueshowteamslot = root.findViewById(R.id.myleagueteamleaderboardshowteamslot);
        myleagueshowteamteamid = root.findViewById(R.id.myleagueteamleaderboardshowteamteamid);
        myleagueshowteamteamname = root.findViewById(R.id.myleagueteamleaderboardshowteamteamname);
        myleagueshowteamrecycler = root.findViewById(R.id.myleagueteamleaderboardshowteamrecycler);
        ...
        fetchdataforpastteams();
    }

    private void fetchdataforpastteams() {
        CommonMethods.LOGthesite(Constants.LOG, "the id is " + id);
        String url = APICallsOkHttp.urlbuilderforhttp(Constants.w3devbaseurl + "user/leaderboard/team/" + id);
